...
#' 
#' The package \code{parental} provides lightweight tools for creating, 
...
.onLoad <- function(libname, pkgname){
  ...
  cat('For citation information, type citation("parental").\n')
  cat('Type help("package-parental") to get started.\n')
}
